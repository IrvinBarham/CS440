...
panel:
  LPAREN IDENT CAPTION ABOVE caption RPAREN { table_one_col
	[(tabcell None $5); (tabcell (Some $2) nocontent)] }

| LPAREN IDENT CAPTION BELOW caption RPAREN { table_one_col 
        [(tabcell (Some $2) nocontent); (tabcell None $5)] }

| LPAREN IDENT CAPTION RIGHT caption RPAREN { table_one_row
        [(tabcell (Some $2) nocontent); (tabcell None $5)] }

| LPAREN IDENT CAPTION LEFT caption RPAREN { table_one_row
        [(tabcell None $5); (tabcell (Some $2) nocontent)] }

| LPAREN IDENT CAPTION OVER caption RPAREN { table_one_row
        [(tabcell (Some $2) $5)] }
;
/*>* Problem 1.2b *>*/ 
