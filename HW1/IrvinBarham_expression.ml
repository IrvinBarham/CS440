...
let rec evaluate (e:expression) (x:float) : float =
	...
	|Neg e1 -> -1.0 *. evaluate e1 x
;;

(* Your answer to problems 3.4 and 3.5 go here *)

(* I spent about a week and most the time was spent researching because we weren't given
   Material we really needed during class. I wish I could research faster but its hard too.
   The homework extension was very good and allowed the necessary time to complete the assignment. 
   I appreciated the extension the Professor gave us on this assignment! *)
